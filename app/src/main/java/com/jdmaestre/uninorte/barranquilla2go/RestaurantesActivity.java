...
public class RestaurantesActivity extends Activity implements ActionBar.TabListener  {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.title_section1_Restaurantes).toUpperCase(l);
                case 1:
                    return getString(R.string.title_section2_Restaurantes).toUpperCase(l);
                case 2:
                    return getString(R.string.title_section3_Restaurantes).toUpperCase(l);
            }
            return null;
        }
    }
